    ...
    return (
        <div className='h-[650px] bg-no-repeat bg-cover bg-center' style={{
            ...
            <div className="flex flex-col items-center py-[160px] h-full gap-8">
                <span className="text-white text-[50px] xl:text-[72px] font-black xl:w-[50%] text-center leading-tight	">{title}</span>


                <a href="#modelos"><button className=" text-white text-[22px] font-bold rounded-full py-4 px-8 bg-red-800 hover:bg-red-600 cursor-pointer">{textButton}</button></a>
            </div>
        </div>
    )
}
